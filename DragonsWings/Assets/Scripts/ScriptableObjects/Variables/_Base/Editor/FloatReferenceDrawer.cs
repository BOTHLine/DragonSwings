...
public class FloatReferenceDrawer : UnityEditor.PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, UnityEditor.SerializedProperty property, GUIContent label)
    {
        ...
        UnityEditor.SerializedProperty map = property.FindPropertyRelative("Map");
        UnityEditor.SerializedProperty mapIdentifier = property.FindPropertyRelative("MapIdentifier");
        ...
        switch (useType.intValue)
        {
            ...
            case (int)ReferenceUseType.Set:
                ...
                UnityEditor.EditorGUI.PropertyField(position, mapIdentifier, GUIContent.none);

                positionSecond.xMin = position.xMax;
                UnityEditor.EditorGUI.PropertyField(positionSecond, map, GUIContent.none);
                break;
        }
